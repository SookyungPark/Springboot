...
public class ProjectController {
    ...
    public String getMembers(Model model){
        ...
        team1.add(new User("acorn1","윤현기", "010-1234-5678"));
    ...
    public String getMembers2(Model model){
        ...
        team2.add(new User("acorn2","정연수", "010-4853-7624"));
        team2.add(new User("acorn2","김유민", "010-3609-4215"));
        team2.add(new User("acorn2","이정호", "010-8940-5832"));
        team2.add(new User("acorn2","김민환", "010-3827-5448"));
        team2.add(new User("acorn2","황예지", "010-7766-5927"));
        team2.add(new User("acorn2","오윤석", "010-5344-3615"));
    ...
    public String getMembers3(Model model){
        ...
        team3.add(new User("acorn3","최지태", "010-2063-5040"));
        team3.add(new User("acorn3","박시우", "010-8666-7993"));
        team3.add(new User("acorn3","박수경", "010-3272-9011"));
        team3.add(new User("acorn3","박예린", "010-5386-2795"));
        team3.add(new User("acorn3","이동우", "010-5344-3615"));
        team3.add(new User("acorn3","최하은", "010-2477-5476"));
    ...
    //1, 2, 3조 명단 (Map)
    @GetMapping("/teamAll")
    public String getProjextAll(Model model){
        //
        List<User> team1 = new ArrayList<>();
        team1.add(new User("acorn1","윤현기", "010-1234-5678"));
        team1.add(new User("acorn1","권지언", "010-4699-6749"));
